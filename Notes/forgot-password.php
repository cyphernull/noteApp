...
$time = time();
$status = 'pending';
$sql = "INSERT INTO forgotpassword (`user_id`, `activate_key`, `time`, `status`) VALUES ('$user_id', '$key', '$time', '$status')";
$result = mysqli_query($link, $sql);
if(!$result){
...
$message="<p>Please click on this link to reset your password</p>";
$message.="<a href="."http://ericchoo.s1.natapp.cc/notes/resetpassword.php?user_id=$user_id&key=$key".">Go To Reset</a>";
